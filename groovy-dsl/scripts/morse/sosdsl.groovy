...
state "Dshorton14" means myLed becomes high and buzzer becomes high
state "Dshortoff14" means myLed becomes low and buzzer becomes low
...
from finLettre3 to Dlongon14 when 3.s
from Dlongon14 to Dlongoff14 when 1.s
...
from Lshortoff16 to Llongon16 when 3.s
from Llongon16 to Llongoff16 when 1.s
