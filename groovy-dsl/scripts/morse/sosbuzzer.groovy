...
initial off
state "Sshorton10" means buzzer becomes high
state "Sshortoff10" means buzzer becomes low
state "Sshorton20" means buzzer becomes high
state "Sshortoff20" means buzzer becomes low
state "Sshorton30" means buzzer becomes high
state "Sshortoff30" means buzzer becomes low
state "finLettre0" means buzzer becomes low
state "Olongon11" means buzzer becomes high
state "Olongoff11" means buzzer becomes low
state "Olongon21" means buzzer becomes high
state "Olongoff21" means buzzer becomes low
state "Olongon31" means buzzer becomes high
state "Olongoff31" means buzzer becomes low
state "finLettre1" means buzzer becomes low
state "Sshorton12" means buzzer becomes high
state "Sshortoff12" means buzzer becomes low
state "Sshorton22" means buzzer becomes high
state "Sshortoff22" means buzzer becomes low
state "Sshorton32" means buzzer becomes high
state "Sshortoff32" means buzzer becomes low
